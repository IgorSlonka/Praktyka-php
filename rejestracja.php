                ...
                <div class="col-6">
                    <div class="card bg-dark text-light">
                        <div class="card-body pt-3 text-center">
                            <h3 class="card-title fw-bolder my-4">Rejestracja</h3>
                            <h6 class="card-subtitle my-4">Podaj wymagane dane</h6>
                            <div class="card-text px-3">
                                <form method="post">
                                    <div class="row form-floating my-4 col">
                                    <div class="form-floating my-4 col">
                                        <input type="text" class="form-control bg-dark text-white" id="floatingInput"
                                        name="name" placeholder="imie" autofocus>
                                        <label class="text-white label-nobg" for="floatingInput">Imie</label>
                                    </div>
                                    <div class="form-floating my-4 col">
                                        <input type="text" class="form-control bg-dark text-white" id="floatingInput"
                                        name="surname" placeholder="nazwisko" autofocus>
                                    ...
                                    <!-- create inputs for name, surname, telephone number, email -->
                        ...
                        <div class='card-footer text-center'>
                            <span>Masz juz konto? |
                                <button class="btn btn-dark btn-sm border-white border-1">Rejestracja</button>
                            </span>
                        </div>
                    </div>
                </div>
